  ...
  eyes: {
    ...
    aggregates: {
      "morphology_and_tilt.eye_shape": {
        label: text("Forme des yeux", "Eye shape"),
        description: text("Lecture générale de la forme visible des yeux."),
        kind: "enum",
        priority: 10,
        valueLabels: commonEnumLabels,
      },
      overall_eye_score: { label: text("Score global des yeux", "Overall eye score"), kind: "score", priority: 20 },
      ...
      "morphology_and_tilt.eye_symmetry": { label: text("Symétrie des yeux", "Eye symmetry"), kind: "score", priority: 60 },
      "eyelids_and_sclera.upper_eyelid_exposure": { label: text("Exposition de la paupière supérieure", "Upper eyelid exposure"), kind: "score", priority: 70 },
      "eyelids_and_sclera.lower_scleral_show": { label: text("Sclère inférieure visible", "Lower scleral show"), kind: "score", priority: 80 },
      "eyelids_and_sclera.epicanthic_fold": { label: text("Pli épicanthique", "Epicanthic fold"), kind: "enum", priority: 90, valueLabels: commonEnumLabels },
      "under_eye_health.support_and_hollows": { label: text("Support sous les yeux", "Under-eye support"), kind: "score", priority: 100 },
      "under_eye_health.pigmentation": { label: text("Pigmentation sous les yeux", "Under-eye pigmentation"), kind: "score", priority: 110 },
      "details_and_color.sclera_clarity": { label: text("Clarté de la sclère", "Sclera clarity"), kind: "score", priority: 120 },
      "details_and_color.limbal_ring_visibility": { label: text("Anneau limbique", "Limbal ring visibility"), kind: "enum", priority: 130, valueLabels: commonEnumLabels },
      "details_and_color.eyelash_density": { label: text("Densité des cils", "Eyelash density"), kind: "score", priority: 140 },
      "details_and_color.iris_color": { label: text("Couleur de l’iris", "Iris color"), kind: "enum", priority: 150, valueLabels: commonEnumLabels },
    },
  },
  cheeks: {
