...
const displayMeta: Record<string, WorkerDisplayMeta> = {
  ...
  symmetry_shape: {
    ...
    aggregates: {
      ...
      "face_shape.width_hierarchy": {
        label: text("Hiérarchie des largeurs faciales", "Facial width hierarchy"),
        kind: "enum",
        priority: 15,
      },
      ...
      "proportions.horizontal_fifths_balance": { label: text("Équilibre des cinquièmes horizontaux", "Horizontal fifths balance"), kind: "score", priority: 100 },
      "proportions.eye_to_intercanthal_ratio": { label: text("Rapport œil / distance intercanthale", "Eye / intercanthal ratio"), kind: "score", priority: 110 },
      "face_shape.forehead_vs_jaw_ratio": { label: text("Rapport front / mâchoire", "Forehead / jaw ratio"), kind: "score", priority: 120 },
      "face_shape.face_length_vs_width_ratio": { label: text("Rapport longueur / largeur", "Face length / width ratio"), kind: "score", priority: 130 },
    },
  },
  bodyfat: {
    ...
    aggregates: {
      "global_estimation.facial_leanness_score": {
        label: text("Minceur faciale globale", "Facial leanness"),
        kind: "score",
        priority: 10,
      },
      "global_estimation.estimated_body_fat_percentage": {
        label: text("Masse grasse corporelle estimée", "Estimated body fat"),
        kind: "score",
        priority: 15,
      },
      "water_retention_flag.level": {
        label: text("Rétention d'eau", "Water retention"),
        kind: "enum",
        priority: 20,
        valueLabels: {
          none: text("Aucune", "None"),
          low: text("Faible", "Low"),
          mild: text("Légère", "Mild"),
          moderate: text("Modérée", "Moderate"),
          elevated: text("Élevée", "Elevated"),
          high: text("Forte", "High"),
        },
      },
      "lower_face_neck.jawline_definition": {
        label: text("Définition de la mâchoire", "Jawline definition"),
        kind: "score",
        priority: 30,
      },
      "lower_face_neck.submental_fat_tightness": {
        label: text("Tension sous le menton", "Submental fat tightness"),
        kind: "score",
        priority: 40,
      },
      "midface_buccal.buccal_leanness": {
        label: text("Minceur des joues", "Buccal leanness"),
        kind: "score",
        priority: 50,
      },
      "midface_buccal.zygomatic_bone_visibility": {
        label: text("Visibilité des pommettes", "Zygomatic bone visibility"),
        kind: "score",
        priority: 60,
      },
      "upper_face_skin.periocular_leanness": {
        label: text("Minceur du contour des yeux", "Periocular leanness"),
        kind: "score",
        priority: 70,
      },
      "upper_face_skin.facial_angularity": {
        label: text("Angularité du visage", "Facial angularity"),
        kind: "score",
        priority: 80,
      },
      /** @deprecated Ancienne sortie API — conservé pour analyses déjà stockées. */
  ...
  eyes: {
    ...
    aggregates: {
      "global_score.overall_eye_score": {
        label: text("Score global des yeux", "Overall eye score"),
        kind: "score",
        priority: 5,
      },
      ...
      "morphology_and_tilt.eye_symmetry": {
        label: text("Symétrie des yeux", "Eye symmetry"),
        kind: "score",
        priority: 50,
      },
      "eyelids_and_sclera.upper_eyelid_exposure": {
        label: text("Exposition de la paupière supérieure", "Upper eyelid exposure"),
        kind: "score",
        priority: 60,
      },
      "eyelids_and_sclera.lower_scleral_show": {
        label: text("Sclère inférieure visible", "Lower scleral show"),
        kind: "score",
        priority: 70,
      },
      "eyelids_and_sclera.epicanthic_fold": {
        label: text("Pli épicanthique", "Epicanthic fold"),
        kind: "enum",
        priority: 80,
        valueLabels: commonEnumLabels,
      },
      "under_eye_health.under_eye_support": {
        label: text("Support sous les yeux", "Under-eye support"),
        kind: "score",
        priority: 90,
      },
      "under_eye_health.under_eye_pigmentation": {
        label: text("Pigmentation sous les yeux", "Under-eye pigmentation"),
        kind: "score",
        priority: 100,
      },
      "iris_sclera_and_lashes.sclera_clarity": {
        label: text("Clarté de la sclère", "Sclera clarity"),
        kind: "score",
        priority: 110,
      },
      "iris_sclera_and_lashes.limbal_ring_visibility": {
        label: text("Anneau limbique", "Limbal ring visibility"),
        kind: "enum",
        priority: 120,
        valueLabels: commonEnumLabels,
      },
      "iris_sclera_and_lashes.eyelash_density": {
        label: text("Densité des cils", "Eyelash density"),
        kind: "score",
        priority: 130,
      },
      "iris_sclera_and_lashes.iris_color": {
        label: text("Couleur de l’iris", "Iris color"),
        kind: "enum",
        priority: 140,
        valueLabels: commonEnumLabels,
      },
  ...
  cheeks: {
    ...
    aggregates: {
      "global_score.overall_cheek_score": {
        label: text("Score global des joues", "Overall cheek score"),
        kind: "score",
        priority: 10,
      },
      "frontal_structure.bizygomatic_width": {
        label: text("Largeur bizygomatique", "Bizygomatic width"),
        kind: "score",
        priority: 20,
      },
      "frontal_structure.malar_eminence_prominence": {
        label: text("Prominence des malars", "Malar eminence prominence"),
        kind: "score",
        priority: 30,
      },
      "frontal_structure.cheek_symmetry": {
        label: text("Symétrie des joues", "Cheek symmetry"),
        kind: "score",
        priority: 40,
      },
      "profile_structure.cheekbone_height_peak": {
        label: text("Hauteur des pommettes", "Cheekbone height peak"),
        kind: "score",
        priority: 50,
      },
      "profile_structure.zygomatic_projection_and_arch": {
        label: text("Projection et arc zygomatique", "Zygomatic projection & arch"),
        kind: "score",
        priority: 60,
      },
      "profile_structure.ogee_curve": {
        label: text("Courbe en S (ogee)", "Ogee curve"),
        kind: "score",
        priority: 70,
      },
      "harmony.midface_dominance": {
        label: text("Dominance du midface", "Midface dominance"),
        kind: "score",
        priority: 80,
      },
    },
  ...
  chin: {
    ...
    aggregates: {
      "global_score.overall_chin_score": {
        label: text("Score global du menton", "Overall chin score"),
        kind: "score",
        priority: 5,
      },
      "shape_and_contour.chin_shape": {
        label: text("Forme du menton", "Chin shape"),
        kind: "enum",
        priority: 10,
      },
      "shape_and_contour.chin_contour": {
        label: text("Contour du menton", "Chin contour"),
        kind: "score",
        priority: 20,
      },
      "shape_and_contour.chin_dimple": {
        label: text("Fossette du menton", "Chin dimple"),
        kind: "enum",
        priority: 40,
      },
      "projection_and_profile.chin_projection": {
        label: text("Projection du menton", "Chin projection"),
        kind: "score",
        priority: 50,
      },
      "projection_and_profile.chin_height": {
        label: text("Hauteur du menton", "Chin height"),
        kind: "score",
        priority: 70,
      },
      "width_and_integration.chin_width": {
        label: text("Largeur du menton", "Chin width"),
        kind: "score",
        priority: 80,
      },
      "width_and_integration.lower_face_integration": {
        label: text("Intégration du bas du visage", "Lower face integration"),
        kind: "score",
        priority: 90,
      },
    },
  ...
  neck: {
    label: text("Cou", "Neck"),
    aggregates: {
      "global_score.overall_neck_score": {
        label: text("Score global du cou", "Overall neck score"),
        kind: "score",
        priority: 5,
      },
      "dimensions_and_proportions.neck_length": {
        label: text("Longueur du cou", "Neck length"),
        kind: "score",
        priority: 10,
      },
      "dimensions_and_proportions.neck_width": {
        label: text("Largeur du cou", "Neck width"),
        kind: "score",
        priority: 20,
      },
      "dimensions_and_proportions.neck_shape_and_taper": {
        label: text("Forme et affinement du cou", "Neck shape & taper"),
        kind: "score",
        priority: 30,
      },
      "dimensions_and_proportions.neck_shape_and_taper.descriptor": {
        label: text("Descripteur forme / affinement", "Shape & taper descriptor"),
        kind: "enum",
        priority: 35,
        valueLabels: commonEnumLabels,
      },
      "musculature_and_soft_tissue.scm_muscle_definition": {
        label: text("Définition du muscle SCM", "SCM muscle definition"),
        kind: "score",
        priority: 40,
      },
      "musculature_and_soft_tissue.neck_firmness": {
        label: text("Fermeté du cou", "Neck firmness"),
        kind: "score",
        priority: 50,
      },
      "musculature_and_soft_tissue.adams_apple_visibility": {
        label: text("Visibilité de la pomme d'Adam", "Adam's apple visibility"),
        kind: "enum",
        priority: 60,
        valueLabels: commonEnumLabels,
      },
      "posture_and_alignment.neck_posture": {
        label: text("Posture du cou", "Neck posture"),
        kind: "score",
        priority: 90,
      },
    },
  ...
  nose: {
    ...
    aggregates: {
      "global_score.overall_nose_score": {
        label: text("Score global du nez", "Overall nose score"),
        kind: "score",
        priority: 5,
      },
      "frontal_symmetry_and_width.nose_symmetry": {
        label: text("Symétrie du nez", "Nose symmetry"),
        kind: "score",
        priority: 10,
      },
      "frontal_symmetry_and_width.overall_alar_width": {
        label: text("Largeur globale des ailes du nez", "Overall alar width"),
        kind: "score",
        priority: 20,
      },
      "frontal_symmetry_and_width.bridge_width": {
        label: text("Largeur de l'arête nasale", "Bridge width"),
        kind: "score",
        priority: 30,
      },
      "profile_dorsum_and_angles.bridge_shape": {
        label: text("Forme de l'arête nasale", "Bridge shape"),
        kind: "enum",
        priority: 40,
      },
      "profile_dorsum_and_angles.supratip_break": {
        label: text("Cassure supratip", "Supratip break"),
        kind: "enum",
        priority: 50,
      },
      "profile_dorsum_and_angles.nasofrontal_angle": {
        label: text("Angle nasofrontal", "Nasofrontal angle"),
        kind: "score",
        priority: 60,
      },
      "profile_dorsum_and_angles.nasolabial_angle_rotation": {
        label: text("Angle nasolabial et rotation", "Nasolabial angle and rotation"),
        kind: "score",
        priority: 70,
      },
      "tip_morphology.tip_definition": {
        label: text("Définition de la pointe", "Tip definition"),
        kind: "score",
        priority: 80,
      },
      "tip_morphology.tip_projection": {
        label: text("Projection de la pointe", "Tip projection"),
        kind: "score",
        priority: 90,
      },
      "base_nostrils_and_surface.nostril_shape": {
        label: text("Forme des narines", "Nostril shape"),
        kind: "enum",
        priority: 100,
      },
      "base_nostrils_and_surface.columella_alignment": {
        label: text("Alignement de la columelle", "Columella alignment"),
        kind: "score",
        priority: 110,
      },
      "base_nostrils_and_surface.nose_length": {
        label: text("Longueur du nez", "Nose length"),
        kind: "score",
        priority: 120,
      },
      "base_nostrils_and_surface.nasal_skin_surface": {
        label: text("Surface cutanée nasale", "Nasal skin surface"),
        kind: "enum",
        priority: 125,
      },
    },
  ...
  skin: {
    ...
    aggregates: {
      ...
      "texture_pores_and_congestion.blackheads_and_congestion": {
        label: text("Points noirs et congestion", "Blackheads and congestion"),
        kind: "score",
        priority: 20,
      },
      "texture_pores_and_congestion.surface_smoothness": {
        label: text("Lissage de la surface cutanée", "Surface smoothness"),
        kind: "score",
        priority: 30,
      },
      ...
      "acne_and_scarring.post_inflammatory_marks": {
        label: text("Marques post-inflammatoires", "Post-inflammatory marks"),
        kind: "score",
        priority: 45,
      },
      "acne_and_scarring.atrophic_scarring": {
        label: text("Cicatrices atrophiques", "Atrophic scarring"),
        kind: "score",
        priority: 50,
      },
      "pigmentation_tone_and_redness.color_uniformity": {
        label: text("Uniformité du teint", "Color uniformity"),
        kind: "score",
        priority: 60,
      },
      "pigmentation_tone_and_redness.redness_and_erythema": {
        label: text("Rougeurs et érythème", "Redness and erythema"),
        kind: "score",
        priority: 70,
      },
      "hydration_and_vitality.sebum_hydration_balance": {
        label: text("Équilibre sébum-hydratation", "Sebum hydration balance"),
        kind: "score",
        priority: 80,
      },
      "hydration_and_vitality.firmness_and_elasticity": {
        label: text("Fermeté et élasticité", "Firmness and elasticity"),
        kind: "score",
        priority: 90,
      },
      "global_score.overall_skin_score": {
        label: text("Score global de la peau", "Overall skin score"),
        kind: "score",
        priority: 100,
      },
    },
  ...
  smile: {
    ...
    aggregates: {
      "dental_quality.shade_and_whiteness": {
        label: text("Teinte et blancheur des dents", "Tooth shade and whiteness"),
        kind: "score",
        priority: 10,
      },
      "dental_quality.tooth_color_descriptor": {
        label: text("Descripteur de couleur des dents", "Tooth color descriptor"),
        kind: "enum",
        priority: 15,
      },
      "dental_quality.surface_integrity": {
        label: text("Intégrité de la surface dentaire", "Surface integrity"),
        kind: "score",
        priority: 20,
      },
      "dental_quality.tooth_proportions": {
        label: text("Proportions dentaires", "Tooth proportions"),
        kind: "score",
        priority: 30,
      },
      "smile_architecture.dental_alignment": {
        label: text("Alignement dentaire", "Dental alignment"),
        kind: "score",
        priority: 40,
      },
      "smile_architecture.midline_alignment": {
        label: text("Alignement de la ligne médiane", "Midline alignment"),
        kind: "score",
        priority: 50,
      },
      "smile_architecture.smile_arc": {
        label: text("Arc du sourire", "Smile arc"),
        kind: "enum",
        priority: 60,
      },
      "smile_dynamics.smile_symmetry": {
        label: text("Symétrie du sourire", "Smile symmetry"),
        kind: "score",
        priority: 70,
      },
      "smile_dynamics.buccal_corridors": {
        label: text("Corridors buccaux", "Buccal corridors"),
        kind: "score",
        priority: 80,
      },
      "smile_dynamics.teeth_visibility_count": {
        label: text("Nombre de dents visibles", "Visible teeth count"),
        kind: "enum",
        priority: 90,
      },
      "smile_dynamics.lower_teeth_visibility": {
        label: text("Visibilité des dents inférieures", "Lower teeth visibility"),
        kind: "enum",
        priority: 95,
      },
      "smile_dynamics.gingival_display": {
        label: text("Exposition gingivale", "Gingival display"),
        kind: "score",
        priority: 100,
      },
      "smile_dynamics.upper_lip_curvature": {
        label: text("Courbure de la lèvre supérieure", "Upper lip curvature"),
        kind: "enum",
        priority: 110,
      },
      "facial_impact.duchenne_activation": {
        label: text("Activation de Duchenne", "Duchenne activation"),
        kind: "enum",
        priority: 120,
        valueLabels: commonEnumLabels,
      },
      "facial_impact.cheek_dimples": {
        label: text("Fossettes des joues", "Cheek dimples"),
        kind: "enum",
        priority: 130,
      },
      "global_score.overall_smile_score": {
        label: text("Score global du sourire", "Overall smile score"),
        kind: "score",
        priority: 140,
      },
    },
  ...
  skin_tint: {
    ...
    aggregates: {
      ...
      "vitality_and_radiance.color_radiance_glow": {
        label: text("Éclat et luminosité du teint", "Skin radiance and glow"),
        kind: "score",
        priority: 30,
      },
      "vitality_and_radiance.sallowness_absence": {
        label: text("Absence de teint terne", "Absence of sallowness"),
        kind: "score",
        priority: 40,
      },
      "pigment_distribution.melanin_uniformity": {
        label: text("Uniformité de la mélanine", "Melanin uniformity"),
        kind: "score",
        priority: 50,
      },
      "pigment_distribution.periorbital_perioral_match": {
        label: text(
          "Cohérence contour des yeux / contour de la bouche",
          "Periorbital / perioral match",
        ),
        kind: "score",
        priority: 60,
      },
      "sun_exposure_aesthetic.tan_level": {
        label: text("Niveau de bronzage", "Tan level"),
        kind: "enum",
        priority: 70,
      },
      "sun_exposure_aesthetic.tan_uniformity": {
        label: text("Uniformité du bronzage", "Tan uniformity"),
        kind: "score",
        priority: 75,
      },
      "sun_exposure_aesthetic.tan_phototype_harmony": {
        label: text("Harmonie bronzage / phototype", "Tan / phototype harmony"),
        kind: "score",
        priority: 78,
      },
      "global_score.overall_colorimetry_score": {
        label: text("Score global de colorimétrie", "Overall colorimetry score"),
        kind: "score",
        priority: 90,
      },
    },
  ...
  eye_brows: {
    ...
    aggregates: {
      "placement_and_symmetry.eyebrow_elevation": {
        label: text("Hauteur des sourcils", "Eyebrow elevation"),
        kind: "score",
        priority: 10,
      },
      "placement_and_symmetry.eyebrow_symmetry": {
        label: text("Symétrie des sourcils", "Eyebrow symmetry"),
        kind: "score",
        priority: 20,
      },
      "geometry_and_shape.eyebrow_tilt": {
        label: text("Inclinaison des sourcils", "Eyebrow tilt"),
        kind: "enum",
        priority: 30,
        valueLabels: {
          negative: text("Négative", "Negative"),
      ...
      "geometry_and_shape.eyebrow_shape": {
        label: text("Forme des sourcils", "Eyebrow shape"),
        kind: "enum",
        priority: 40,
        valueLabels: {
          straight: text("Droit", "Straight"),
      ...
      "geometry_and_shape.tail_length_and_direction": {
        label: text("Longueur et direction de la queue", "Tail length and direction"),
        kind: "score",
        priority: 50,
      },
      "geometry_and_shape.inner_start_shape": {
        label: text("Forme du départ interne", "Inner start shape"),
        kind: "enum",
        priority: 60,
        valueLabels: {
          squared: text("Carré", "Squared"),
      ...
      "density_grooming_and_glabella.eyebrow_thickness": {
        label: text("Épaisseur des sourcils", "Eyebrow thickness"),
        kind: "score",
        priority: 70,
      },
      "density_grooming_and_glabella.eyebrow_density": {
        label: text("Densité des sourcils", "Eyebrow density"),
        kind: "score",
        priority: 80,
      },
      "density_grooming_and_glabella.glabellar_hair": {
        label: text("Poils entre les sourcils", "Glabellar hair"),
        kind: "score",
        priority: 90,
      },
      "density_grooming_and_glabella.grooming_quality": {
        label: text("Qualité du toilettage", "Grooming quality"),
        kind: "enum",
        priority: 100,
        valueLabels: {
          natural_untouched: text("Naturel non retouché", "Natural untouched"),
          well_groomed: text("Bien entretenu", "Well groomed"),
          over_groomed: text("Sur-travaillé", "Over-groomed"),
          unkempt: text("Négligé", "Unkempt"),
        },
      },
      "density_grooming_and_glabella.brow_color": {
        label: text("Couleur des sourcils", "Brow color"),
        kind: "enum",
        priority: 110,
        valueLabels: {
          light_blonde: text("Blond clair", "Light blonde"),
          dark_blonde: text("Blond foncé", "Dark blonde"),
          red: text("Roux", "Red"),
          light_brown: text("Châtain clair", "Light brown"),
          dark_brown: text("Châtain foncé", "Dark brown"),
          black: text("Noir", "Black"),
          grey: text("Gris", "Grey"),
        },
      },
      "global_score.overall_brow_score": {
        label: text("Score global des sourcils", "Overall brow score"),
        kind: "score",
        priority: 120,
      },
    },
  ...
  hair: {
    ...
    aggregates: {
      "hair_quality_and_health.density": {
        label: text("Densité capillaire", "Hair density"),
        kind: "score",
        priority: 10,
      },
      "hair_quality_and_health.shine_and_dryness": {
        label: text("Brillance et sécheresse", "Shine and dryness"),
        kind: "score",
        priority: 20,
      },
      "hair_quality_and_health.health_appearance": {
        label: text("Apparence de santé capillaire", "Hair health appearance"),
        kind: "score",
        priority: 30,
      },
      "hair_quality_and_health.uniformity": {
        label: text("Uniformité capillaire", "Hair uniformity"),
        kind: "score",
        priority: 40,
      },
      ...
      "grooming_and_haircut.haircut_control": {
        label: text("Maîtrise de la coupe", "Haircut control"),
        kind: "score",
        priority: 50,
      },
      "hair_characteristics.texture_type": {
        label: text("Type de texture", "Texture type"),
        kind: "enum",
        priority: 60,
        valueLabels: commonEnumLabels,
      },
      "hair_characteristics.curl_definition": {
        label: text("Définition des boucles", "Curl definition"),
        kind: "score",
        priority: 70,
      },
      "hair_characteristics.length_category": {
        label: text("Catégorie de longueur", "Length category"),
        kind: "enum",
        priority: 80,
        valueLabels: commonEnumLabels,
      },
      "hairline.shape": {
        label: text("Forme de la ligne capillaire", "Hairline shape"),
        kind: "enum",
        priority: 90,
      },
      "hairline.symmetry": {
        label: text("Symétrie de la ligne capillaire", "Hairline symmetry"),
        kind: "score",
        priority: 100,
      },
      "hairline.density": {
        label: text("Densité de la ligne capillaire", "Hairline density"),
        kind: "score",
        priority: 110,
      },
      "hairline.recession_level": {
        label: text("Niveau de recul capillaire", "Hairline recession level"),
        kind: "score",
        priority: 120,
      },
      "global_score.overall_hair_score": {
        label: text("Score global des cheveux", "Overall hair score"),
        kind: "score",
        priority: 130,
      },
    },
  ...
  jaw: {
    ...
    aggregates: {
      "global_score.overall_jaw_score": {
        label: text("Score global de la mâchoire", "Overall jaw score"),
        kind: "score",
        priority: 5,
      },
      "frontal_geometry.jaw_shape_frontal": {
        label: text("Forme frontale de la mâchoire", "Frontal jaw shape"),
        kind: "enum",
        priority: 10,
      },
      "frontal_geometry.jaw_width": {
        label: text("Largeur de la mâchoire", "Jaw width"),
        kind: "score",
        priority: 20,
      },
      "frontal_geometry.jaw_to_face_proportion": {
        label: text("Proportion mâchoire-visage", "Jaw to face proportion"),
        kind: "score",
        priority: 30,
      },
      "profile_architecture.jaw_shape_side": {
        label: text("Forme de profil de la mâchoire", "Side jaw shape"),
        kind: "enum",
        priority: 40,
      },
      "profile_architecture.jaw_height_ramus": {
        label: text("Hauteur du ramus mandibulaire", "Ramus height"),
        kind: "score",
        priority: 50,
      },
      "profile_architecture.jawline_length": {
        label: text("Longueur de la ligne mandibulaire", "Jawline length"),
        kind: "score",
        priority: 60,
      },
      "symmetry_and_flare.jaw_symmetry": {
        label: text("Symétrie de la mâchoire", "Jaw symmetry"),
        kind: "score",
        priority: 70,
      },
      "symmetry_and_flare.gonial_flare_symmetry": {
        label: text("Symétrie du flare gonial", "Gonial flare symmetry"),
        kind: "score",
        priority: 80,
      },
    },
